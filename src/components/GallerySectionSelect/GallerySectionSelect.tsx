...
const GallerySectionSelect: React.FC<GallerySectionSelectProps> = ({ value, onChange }) => {

	return (
		<Select value={value} onChange={(e) => onChange(e.target.value as GallerySectionFilter)}>
