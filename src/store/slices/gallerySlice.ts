...
export const gallerySlice = createSlice({
	...
	reducers: {
		...
		previousPage: (state) => {
			state.filters.page !== undefined && state.filters.page > 0 && state.filters.page--;
		},
	}
});

export const { setSection, setSort, setPage, nextPage, previousPage, setWindow, setShowViral, } = gallerySlice.actions;
